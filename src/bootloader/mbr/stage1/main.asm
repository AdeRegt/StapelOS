...
welcome_message db "Welcome to StapelOS Bootloader",0x00
loadedmsg db " has been loaded",0x00
...
load_file_sector:
	...
	mov ax, 4000h			; Set buffer past what we've already read
	mov es, ax
	mov bx, word [pointer]
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "KERNEL64SYS"	; MikeOS kernel filename
	db 0x00
	disk_error	db "Floppy error! Press any key...", 0
	file_not_found	db "KERNEL64.SYS not found!", 0
