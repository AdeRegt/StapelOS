...
OEMLabel		db "STAPELOS"	; Disk label
...
VolumeLabel		db "STAPELOS   "; Volume Label: any 11 chars
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "16TO64  SYS"	; MikeOS kernel filename

	disk_error	db "Floppy error! Press any key...", 0
	file_not_found	db "16TO64.SYS not found!", 0
