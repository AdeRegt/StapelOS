...
void xhci_initialise_port(int portno)
{
  ...
  printk("getting portspeed          : %s \n",xhci_get_port_speed(portno));
  ...
  printk("testing device-ring        : ");
  xhci_request_ring_test(ringinfo,deviceid);

  printk("getting device-descriptor  : ");
  xhci_request_device_descriptor(ringinfo,deviceid);

  printk("getting device-configuratio: ");
  xhci_request_device_configuration(ringinfo,deviceid);
}
